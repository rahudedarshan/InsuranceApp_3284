...
import com.nd.sevice.DcMgmtService;
...
public class DataCollectionOperationsController {
   ...
   public ResponseEntity<Integer> generateCaseNo(@PathVariable Integer appId){
	...
	@PutMapping("/savePlan")
	public  ResponseEntity<Integer> savePlanSelection(@RequestBody planSelectionInput planInputs){
		   //user service
	...
	public ResponseEntity<Integer> saveEducationData(@RequestBody EducationInput educationinputs){
		//use service
	...
	public  ResponseEntity<Integer> saveChildrensData(@RequestBody List<ChildInputs> childInputs){
		//user service
